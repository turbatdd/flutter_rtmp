...
#if __has_include("flutter_rtmp/flutter_rtmp-Swift.h")
#import <flutter_rtmp/flutter_rtmp-Swift.h>
#else
// Support project import fallback if the generated compatibility header
// is not copied when this plugin is created as a library.
// https://forums.swift.org/t/swift-static-libraries-dont-copy-generated-objective-c-header/19816
#import "flutter_rtmp-Swift.h"
#endif
...
- (void)startImageStreamWithMessenger:(NSObject<FlutterBinaryMessenger> *)messenger {
    if (!_isStreamingImages) {
        ...
        [FlutterEventChannel eventChannelWithName:@"plugins.flutter.io/flutter_rtmp/imageStream"
...
+ (void)registerWithRegistrar:(NSObject<FlutterPluginRegistrar> *)registrar {
    ...
    [FlutterMethodChannel methodChannelWithName:@"plugins.flutter.io/flutter_rtmp"
...
- (void)handleMethodCall:(FlutterMethodCall *)call result:(FlutterResult)result {
    if (_dispatchQueue == nil) {
        _dispatchQueue = dispatch_queue_create("com.turbatdd.flutter_rtmp.dispatchqueue", NULL);
    }
        ...
        if (error) {
            ...
            FlutterEventChannel *eventChannel = [FlutterEventChannel
                                                 eventChannelWithName:[NSString
                                                                       stringWithFormat:@"plugins.flutter.io/flutter_rtmp/cameraEvents%lld",
                                                                       textureId]
